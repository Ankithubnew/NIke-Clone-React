        ...
        <>
            <Box>
                ...
                <Flex flexDirection={'column'} gap={'20px'}>
                    ...
                    <Text fontSize={'20px'} fontWeight={600} mt={'30px'}>What's your PAN information?</Text>
                    <Input onChange={onChange} type={'text'} name={'PAN'} placeholder={'PAN*'} />
                    <Checkbox >
                    I have read and consent to processing my information in accordance with the privacy statement.
                    </Checkbox>
